...
function resetUI() {
  ...
  document.getElementById('adScreen').innerHTML = `<svg width="64" height="64" viewBox="0 0 24 24"><polygon points="6,4 20,12 6,20" fill="#111111"></polygon></svg>`;
}
