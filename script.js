...
function generateRefLink() {
  return `https://t.me/Win_Tube_Bot/WinTube/${userId}`;
}
...
async function playAd(adType) {
  ...
  btn1.disabled = true;
  btn2.disabled = true;
  document.getElementById('adScreen').innerHTML = `<div style="font-weight:700;font-size:13px;">Loading ${adType} Ad...</div>`;
...
async function init() {
  ...
  // 🔗 Process referral from URL path (e.g., /WinTube/TG_123)
